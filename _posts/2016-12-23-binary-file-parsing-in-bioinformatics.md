...
<!-- {% include image name="hts-specs_SAMv1_bai.png" caption="BAI binary file structure" %} -->

![BAI binary file structure](2016-12-23-binary-file-parsing-in-bioinformatics/hts-specs_SAMv1_bai.png)
